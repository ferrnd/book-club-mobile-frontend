  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Image
          source={{
            uri: "https://raw.githubusercontent.com/ferrnd/book-club-mobile-backend/refs/heads/main/images/bookCover/icone-olhos-da-agua-creme.png",
          }}
      ...
      <ScrollView contentContainerStyle={styles.tela}>
        ...
        {citacao && (
          <View style={styles.secao}>
            ...
            <ImageBackground
              source={{
                uri: "https://raw.githubusercontent.com/ferrnd/book-club-mobile-backend/refs/heads/main/images/bookCover/parte-tras.png",
              }}
              style={styles.frase}
