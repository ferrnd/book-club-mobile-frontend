      ...
      >
        ...
        <View style={styles.secao}>
          <View style={styles.card}>
            ...
            <View style={styles.divisor} />
            <Text style={styles.explicacaoP}>
              {pt ? rats.contexto : rats.contexto_en}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.secao}>
          <View style={styles.card}>
            ...
            <View style={styles.tagsContainer}>
              {rats.personagens.map((personagem, index) => (
        ...
        <View style={styles.secao}>
          <View style={styles.card}>
            ...
            <Text style={styles.explicacaoP}>
              {pt
                ? rats.caracteristicasLiterarias
                : rats.caracteristicasLiterarias_en}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.secao}>
          <View style={styles.card}>
            <Text style={styles.subt}>{pt ? "Conclusão" : "Conclusion"}
              ...
              <View style={styles.divisor} />
            <Text style={styles.explicacaoP}>
              {pt ? rats.conclusao : rats.conclusao_en}
            </Text>
          </View>
        </View>
      </ScrollView>
