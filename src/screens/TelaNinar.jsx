        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            <ScrollView
                ...
                <View style={styles.secao}>
                    <Text style={styles.secaoT}>{pt ? 'Sobre a Obra' : 'About the Work'}</Text>
                    <View style={[styles.card, styles.livroCard]}>
                        ...
                        <View style={styles.info}>
                            ...
                            <Text style={styles.livroGenero}>
                                {pt ? pedro.genero : pedro.genero_en}
                            </Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.secao}>
                    <View style={styles.card}>
                        ...
                        <Text style={styles.explicacaoP}>
                            {pt ? pedro.resumo : pedro.resumo_en}
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.secao}>
                    <View style={styles.card}>
                        <Text style={styles.subt}>{pt ? 'Contexto da Obra' : 'Work Context'}</Text>
                        <View style={styles.divisor} />
                        <Text style={styles.explicacaoP}>
                            {pt ? pedro.contexto : pedro.contexto_en}
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.secao}>
                    <View style={styles.card}>
                        ...
                        <View style={styles.divisor} />
                        <Text style={styles.explicacaoP}>
                            {pt ? pedro.enredo : pedro.enredo_en}
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.secao}>
                    <View style={styles.card}>
                        ...
                        <View style={styles.tagsContainer}>
                            {pedro.personagens.map((personagem, index) => (
                ...
                <View style={styles.secao}>
                    <View style={styles.card}>
                        ...
                        <Text style={styles.explicacaoP}>
                            {pt
                                ? pedro.caracteristicasLiterarias
                                : pedro.caracteristicasLiterarias_en}
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.secao}>
                    <View style={styles.card}>
                        ...
                        <View style={styles.divisor} />
                        <Text style={styles.explicacaoP}>
                            {pt ? pedro.conclusao : pedro.conclusao_en}
                        </Text>
                    </View>
                </View>
            </ScrollView>
